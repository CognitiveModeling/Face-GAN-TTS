...
class FaceTTS(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train/duration_loss", dur_loss, sync_dist=True)
        self.log("train/prior_loss", prior_loss, sync_dist=True)
        self.log("train/diffusion_loss", diff_loss, sync_dist=True)
        self.log("train/spk_loss", spk_loss, sync_dist=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val/duration_loss", dur_loss, sync_dist=True)
        self.log("val/prior_loss", prior_loss, sync_dist=True)
        self.log("val/diffusion_loss", diff_loss, sync_dist=True)
        self.log("val/spk_loss", spk_loss, sync_dist=True)
