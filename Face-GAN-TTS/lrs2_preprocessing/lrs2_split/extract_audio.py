...
def main():
    ...
    parser.add_argument('--vid_path', type=str, default='/mnt/lustre/work/butz/bst080/data/mvlrs_v1/lrs2_splitted/mp4', help='Path to video files.')
    parser.add_argument('--aud_path', type=str, default='/mnt/lustre/work/butz/bst080/data/mvlrs_v1/lrs2_splitted/wav', help='Path to save extracted audio files.')
