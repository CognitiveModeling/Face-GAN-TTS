...
# Define paths
too_short_dir = "/mnt/lustre/work/butz/bst080/data/mvlrs_v1/lrs2_splitted/unmatched/too_short"
unmatched_dir = "/mnt/lustre/work/butz/bst080/data/mvlrs_v1/lrs2_splitted/unmatched"
mp4_root_dirs = [
    "/mnt/lustre/work/butz/bst080/data/mvlrs_v1/lrs2_splitted/mp4/train",
    "/mnt/lustre/work/butz/bst080/data/mvlrs_v1/lrs2_splitted/mp4/val",
    "/mnt/lustre/work/butz/bst080/data/mvlrs_v1/lrs2_splitted/mp4/test"
]
...
def check_unmatched_files():
    ...
    for file in os.listdir(unmatched_dir):
        if file.endswith(".mp4"):
            ...
            if found:
                print(f"Removing {file} from unmatched (Found in {spk_dir})")
